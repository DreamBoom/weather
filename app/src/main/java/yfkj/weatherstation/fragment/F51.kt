...
class F51 : LazyFragment() {
    override fun getLayoutResource(): Int = R.layout.f51
    ...
    fun setData() {
        ...
        for (i in reversed.indices) {
            ...
            try {
                values.add(Entry(i.toFloat(), reversed[i].wd.toFloat()))
            } catch (e: Exception) {
                values.add(Entry(0L.toFloat(), reversed[i].wd.toFloat()))
            }
        }
    ...
    fun isShow(): Boolean {
        return this@F51.isResumed && this@F51.userVisibleHint
    }
}